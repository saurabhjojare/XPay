...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserCreatedEventDTO> userCreatedEventConsumerFactory() {
        // Manual deserializer for this specific DTO
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "users-service-group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, deserializer); // pass the manual deserializer
